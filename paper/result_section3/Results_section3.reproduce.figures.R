...
######################main.3.A#####################################
load("./paper/result_section3/source_data/mian:seu_and_sil_of_neuro.RData")
...
######################main.3.B#####################################
load("./paper/result_section3/source_data/mian:seu_and_sil_of_iono.RData")
...
##################supp######################
load("./paper/result_section3/source_data/supp:seu.RData")
